...
export default function Landing() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-yasinga-primary/5 to-yasinga-secondary/5">
      <div className="container mx-auto px-4 py-16">
        {/* Header */}
        <div className="text-center mb-16">
          <div className="flex items-center justify-center space-x-3 mb-6">
            <div className="w-16 h-16 bg-yasinga-primary rounded-xl flex items-center justify-center">
          ...
          <Button 
            ...
            className="yasinga-btn-primary text-lg px-8 py-3"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          <Card className="yasinga-card">
            <CardContent className="p-6 text-center">
              <div className="w-12 h-12 bg-yasinga-primary/10 rounded-lg flex items-center justify-center mx-auto mb-4">
                <Smartphone className="w-6 h-6 text-yasinga-primary" />
              </div>
          ...
          <Card className="yasinga-card">
            <CardContent className="p-6 text-center">
              <div className="w-12 h-12 bg-yasinga-secondary/10 rounded-lg flex items-center justify-center mx-auto mb-4">
          ...
          <Card className="yasinga-card">
            <CardContent className="p-6 text-center">
              <div className="w-12 h-12 bg-yasinga-success/10 rounded-lg flex items-center justify-center mx-auto mb-4">
          ...
          <Card className="yasinga-card">
            <CardContent className="p-6 text-center">
              <div className="w-12 h-12 bg-yasinga-warning/10 rounded-lg flex items-center justify-center mx-auto mb-4">
